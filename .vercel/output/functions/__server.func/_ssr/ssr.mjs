...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CnjWaGzX.mjs");
...
var manifest = { "650857b983da88e4bb7c70c785e32dbb29ea4ff05818a33ce8be5b35e0e4696f": {
	functionName: "discordRequest_createServerFn_handler",
	importer: () => import("./api-3_h_Qa5G.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DjtQSjGF.mjs").then((n) => n.t),
